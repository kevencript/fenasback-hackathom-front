...
import asbac from "../../img/asbac.png";
    ...
    return (
      <section id="lista-ingressos">
        ...
        <div className="container pb-4">
          ...
          {/* <!-- Modal --> */}
          <div class="modal fade" id="modalAsbac" tabindex="-1" role="dialog" aria-labelledby="modalAsbacTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog" role="document">
              <div style={{ width: '95%' }} class="modal-content mx-auto">
                <div class="modal-header">
                  <h5 class="modal-title" id="modalAsbacTitle">Apresente na entrada</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <div class="modal-body">
                  ...
                  <p><b>Local:</b>  Centro de Entretenimento Urbano (CEU)</p>
                  <p><b>Data:</b> 09 de maio de 2020, 08:00</p>
                </div>
                <div class="modal-footer">
                  <button style={{ backgroundColor: "#35337d" }} type="button" class="btn btn-secondary" data-dismiss="modal">Blz!</button>
                </div>
          ...
          <div className="col-12 ">
            <div className="row mb-3" data-toggle="modal" data-target="#modalVilla">
            ...
            <div className="row mb-5" data-toggle="modal" data-target="#modalAsbac">
              <div className="card col-12">

                <div className="row p-1">
                  <div className="col-4 my-auto">
                    <img className="card-img-top" src={asbac} alt="" />
                  </div>
                  <div className="col-8">
                    <b>Entrada Asbac</b>
                    <br />
